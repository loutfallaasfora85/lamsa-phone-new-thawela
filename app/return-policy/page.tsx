...
export const metadata = {
  title: "سياسة الاسترجاع | بائع أثاث ومفروشات منزلية - مرضي جلوي عيشان العميري | سهلناها",
};
          ...
          <div className="space-y-3 sm:space-y-5">
            ...
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 md:p-8 shadow-[0_4px_24px_rgba(0,0,0,0.04)] border border-[#e0e3e5]">
              ...
              <div className="sm:pr-[44px] md:pr-[52px] flex flex-col sm:flex-row gap-2 sm:gap-4">
                <a href="tel:+9665957876073" className="flex items-center gap-2 bg-[#f7f9fb] border border-[#e0e3e5] rounded-lg px-3 sm:px-4 py-2.5 hover:border-[#131b2e] transition-colors">
                  <span className="material-symbols-outlined text-[#131b2e] text-[16px] sm:text-[18px]">phone</span>
                  <span className="text-[12px] sm:text-[13px] md:text-sm font-medium text-[#131b2e]" dir="ltr">+9665957876073</span>
                </a>
                <a href="https://wa.me/9665957876073" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#005047]/5 border border-[#3cddc7]/30 rounded-lg px-3 sm:px-4 py-2.5 hover:border-[#005047] transition-colors">

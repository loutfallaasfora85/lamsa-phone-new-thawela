...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/9665957876073?text=${encodeURIComponent(whatsappMessage)}`, "_blank");
    setSubmitted(true);
  };
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-12 -mt-12 relative z-20 pb-20">
          <div className="grid lg:grid-cols-5 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-2 space-y-5">
              {/* WhatsApp Card */}
              <a href="https://wa.me/9665957876073" target="_blank" rel="noopener noreferrer"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="block text-[#191c1e] font-semibold text-lg" dir="ltr">+9665957876073</span>
                  </div>
                </div>
              </a>

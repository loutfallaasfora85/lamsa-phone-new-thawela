...
export const metadata: Metadata = {
  title: "سياسة الشحن | بائع أثاث ومفروشات منزلية - مرضي جلوي عيشان العميري | سهلناها",
  description: "سياسة الشحن والتوصيل لبائع أثاث ومفروشات منزلية - مرضي جلوي عيشان العميري",
};
